...
<body>
	<div id="uploadFileDialog" style="padding:10px;">
		<form id="publicattachmentadminform"  class="adminform" method="post" action="${ctx}/points/selected/addSelectedPic"  enctype="multipart/form-data" novalidate>
...
function uploadBrokerSucc(){
	parent.setSelectedPicUrl($("#url").val());
}
