...
<body>
	<div id="uploadFileDialog" style="padding:10px;">
		<form id="publicattachmentadminform"  class="adminform" method="post" action="${ctx}/points/banner/addBanPic"  enctype="multipart/form-data" novalidate>
		    <input id="restType" name="restType" type="hidden" value="${restType}" />
...
function uploadBrokerSucc(){
	parent.setBannerPicUrl($("#url").val(),$("#restType").val());
}
